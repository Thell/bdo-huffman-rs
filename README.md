...
|--------------|:------:|:-----:|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|:--------------------:|
| **BaseLine** |   ✅    |  Box  |   351.5 µs   |   163.3 µs   |   106.7 µs   |   48.74 µs   |   36.39 µs   |   552.1 ns   |      200.4 MB/s      |
| **Nested**   |   ✅    |  Box  |   297.6 µs   |   134.8 µs   |   78.44 µs   |   26.11 µs   |   17.17 µs   |   522.0 ns   |      237.7 MB/s      |
| **Nested**   |   ❌    |  Box  |   176.7 µs   |   62.67 µs   |   26.90 µs   |   13.42 µs   |   8.133 µs   |   475.4 ns   |      399.5 MB/s      |
| **Flat**     |   ✅    | Index |   295.7 µs   |   133.0 µs   |   75.66 µs   |   25.63 µs   |   16.82 µs   |   213.3 ns   |      238.8 MB/s      |
| **Flat**     |   ❓    | Const |   181.1 µs   |   69.36 µs   |   28.04 µs   |   13.85 µs   |   8.137 µs   |   225.4 ns   |      387.8 MB/s      |
| **Flat**     |   ❌    | Const |   176.5 µs   |   63.61 µs   |   26.57 µs   |   13.13 µs   |   7.833 µs   | **197.5 ns** |      396.3 MB/s      |
| **Table**    |   ✅    | Index |   57.71 µs   |   27.85 µs   |   18.72 µs   |   10.02 µs   |   6.238 µs   |   1.862 µs   |      1.258 GB/s      |
| **Table**    |   ❓    | Const |   57.09 µs   |   27.13 µs   |   17.99 µs   |   9.308 µs   |   5.400 µs   |   977.0 ns   |      1.258 GB/s      |
| **Table**    |   ❌    | Const | **52.15 µs** | **24.72 µs** | **16.87 µs** | **8.615 µs** | **5.356 µs** |   974.7 ns   |      1.381 GB/s      |
