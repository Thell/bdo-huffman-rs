...
|--------------|:------:|:-----:|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|:--------------------:|
| **BaseLine** |   ✅    |  Box  |   350.8 µs   |   163.5 µs   |   107.1 µs   |   46.39 µs   |   37.42 µs   |   675.9 ns   |      201.5 MB/s      |
| **Nested**   |   ✅    |  Box  |   302.6 µs   |   135.2 µs   |   79.37 µs   |   26.33 µs   |   17.55 µs   |   658.7 ns   |      233.4 MB/s      |
| **Nested**   |   ❌    |  Box  |   175.7 µs   |   61.89 µs   |   27.06 µs   |   13.60 µs   |   8.299 µs   |   609.0 ns   |      403.2 MB/s      |
| **Flat**     |   ✅    | Index |   295.0 µs   |   134.8 µs   |   77.17 µs   |   26.15 µs   |   17.33 µs   |   229.7 ns   |      238.1 MB/s      |
| **Flat**     |   ❓    | Const |   180.8 µs   |   66.85 µs   |   29.57 µs   |   14.62 µs   |   8.417 µs   |   231.4 ns   |      390.5 MB/s      |
| **Flat**     |   ❌    | Const |   176.5 µs   |   65.10 µs   |   26.60 µs   |   13.16 µs   |   7.837 µs   | **218.7 ns** |      400.1 MB/s      |
| **Table**    |   ✅    | Index |   57.89 µs   |   27.97 µs   |   18.82 µs   |   10.13 µs   |   6.361 µs   |   1.890 µs   |      1.256 GB/s      |
| **Table**    |   ❓    | Const |   56.92 µs   |   27.14 µs   |   18.08 µs   |   9.374 µs   |   5.634 µs   |   1.028 µs   |      1.264 GB/s      |
| **Table**    |   ❌    | Const | **53.42 µs** | **25.30 µs** | **17.29 µs** | **8.814 µs** | **5.154 µs** |   1.017 µs   |      1.350 GB/s      |
